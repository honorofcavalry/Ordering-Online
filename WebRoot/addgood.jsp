						...
						<!-- /.panel-heading -->
										<article class="U-article Overflow">
											  ...
											  <section class="Myaddress Overflow">
											   <span class="MDtitle Font14 FontW Block Lineheight35">菜品信息</span>
											   <form action="good/addgood.html" method="post">
											   <table>
											    
											    <tr>
											    <td width="30%" class="Font14 FontW Lineheight35" align="right">上传图片：</td>
											    <td><input name="good_imgpath" type="file"></td>
											    </tr>
											    <tr>
											     <td width="30%" class="Font14 FontW Lineheight35" align="right">菜品名称：</td>
											     <td><input type="text" name="good_name" required value="" class="input_name"></td>
											    </tr>
											    <tr>
											     <td width="30%" class="Font14 FontW Lineheight35" align="right">菜品价格：</td>
											     <td><input type="text" id="good_price" name="good_price"  value="" class="input_name"></td>
											    </tr>
											    <tr>
											     <td width="30%" class="Font14 FontW Lineheight35" align="right">菜品简介：</td>
											     <td><input type="text" name="good_info" required  value="" class="input_addr"></td>
											    </tr>
											    <tr>
											     <td align="right"  width="30%" class="Font14 FontW Lineheight35"></td>
											     <td class="Lineheight35"><input name="" type="submit" value="确认上传" class="Submit"></td>
											    </tr>
											   </table>
											   </form>
											  </section>
