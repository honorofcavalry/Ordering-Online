...
<section class="Psection MT20">
 <form action="user/login.html" id="form1" method="post">
  <table class="login">
  <tr>
  ...
  <td><input type="button" name="" value="登 录" class="Submit_b" onClick="but()">(如果不是会员，<a href="register.jsp" class="BlueA">请注册！<br>          </a> <a href="shoplogin.jsp" class="BlueA">如果是商家用户，请点击这里登陆</a> )</td>
  </tr>
  </table>
 </form>
</section>
