...
<nav class="U-nav Font14 FontW">
 ...
 <article class="U-article Overflow">
  ...
  <section class="AccManage Overflow">
   ...
   <%-- <p>登陆邮箱：${sessionScope.member.m_email } ( <a href="#" target="_blank">更换邮箱</a> )</p>
   <p>手机号码：${sessionScope.member.m_phone } ( <a href="#" target="_blank">更换手机号码</a> ) ( <a href="#" target="_blank">解绑手机</a> )</p> --%>
   <form action="user/touxiang.html" method="post">
    <table>
    <tr>
    <td width="30%" align="right">*修改头像：</td>
    <td><input name="user_img" type="file"><button>确定</button></td>
    </tr>
<%--     <tr>
    <td width="30%" align="right">*姓名：</td>
    <td><input type="text" name="user_" value="${sessionScope.user.user_name }"></td>
    </tr> --%>
    <tr>
    <td></td>
